# Academic Research Memory Bank Instructions (Claude Code)

Use a project-local memory bank for academic research work.

These are team-shared project instructions for Claude Code. The `memory-bank/`
directory is the shared project memory used by all configured agents; it is
