---
name: memory-update
description: Run the end-of-task memory-bank update before finalizing a response. Use after completing any task to synchronize activeContext, progress, and profile-specific completion files.
---
