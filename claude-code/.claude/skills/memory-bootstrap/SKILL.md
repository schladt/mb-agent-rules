...
description: Initialize the project memory-bank/ directory and required files when memory-bank/ is missing or incomplete. Use when starting a new project or when CLAUDE.md references memory-bank files that do not exist yet.
---
