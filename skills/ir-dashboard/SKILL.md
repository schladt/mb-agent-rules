...
```bash
bash /path/to/mb-agent-rules/skills/ir-dashboard/setup.sh /path/to/project \
...
1. Copy `skills/ir-dashboard/dashboard/` → `<project>/dashboard/`
2. Copy `skills/ir-dashboard/scripts/` → `<project>/scripts/`
...
6. Confirm `.agents/skills/evidence-review/SKILL.md` is installed
...
IOCs. Use the installed `evidence-review` skill to perform that judgment-bearing
...
This file is generated by the `evidence-review` skill as the final step of
...
See `skills/evidence-review/SKILL.md` for the JSON schema and writing guidelines.
